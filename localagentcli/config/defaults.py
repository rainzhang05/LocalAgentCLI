...
DEFAULT_CONFIG: dict = {
    ...
    "shell": {
        ...
        "thinking_indicator_style": "dots",
        "thinking_animation_interval_ms": 120,
        "theme": "default",
    ...
    "features": {
        ...
        "multi_agent_path_routing": False,
    },
}
...
CONFIG_SCHEMA: dict[str, tuple[type, Any]] = {
    ...
    "shell.thinking_indicator_enabled": (bool, None),
    "shell.thinking_indicator_style": (str, lambda v: v in ("dots", "line", "pulse")),
    "shell.thinking_animation_interval_ms": (int, lambda v: v >= 40),
    "shell.theme": (str, lambda v: v in ("default", "high-contrast", "mono")),
